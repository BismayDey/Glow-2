...
const Hero = () => {
  ...
  const heroImages = [
    "https://images.unsplash.com/photo-1597910037310-7dd8ddb93e24?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1570554913382-930881f3d030?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1522337660859-02fbefca4702?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
      ...
      <div className="relative h-[70vh] md:h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center">
            ...
            >
              Explore our collection of premium skincare and cosmetics designed to enhance your natural radiance.
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1588516903720-8ceb67f9ef84?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                alt="Beauty model" 
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-5xl font-bright mb-6">What makes you glow</h2>

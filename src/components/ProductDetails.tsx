...
import { Star, ShoppingCart, Heart, ArrowLeft, Check, Info, Clock, Truck, Shield } from 'lucide-react';
...
const ProductDetails: React.FC = () => {
  ...
  const calculateEmi = (price: number, months: number, interestRate: number) => {
  ...
  const selectedEmi = emiOptions.find(option => option.months === selectedEmiPeriod);
  const emiDetails = selectedEmi ? calculateEmi(discountedPrice, selectedEmi.months, selectedEmi.interest) : null;
        ...
        <div>
          ...
          <div className="border-t border-b border-gray-200 py-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                <Heart className={isWishlisted ? 'h-5 w-5 fill-rose-500' : 'h-5 w-5'} />
              </motion.button>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <h3 className="text-lg font-semibold mb-3">EMI Options Available</h3>
            ...
            {emiDetails && (
              <div className="bg-white p-3 rounded-lg border border-gray-200">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="font-medium">₹{emiDetails.monthlyPayment}</span>
                </div>
                <div className="flex justify-between mb-1">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">₹{emiDetails.totalInterest}</span>
                </div>
              </div>
            )}
          </div>
          ...
          {[...Array(4)].map((_, index) => (
            ...
            >
              <div className="aspect-square overflow-hidden">
                <img
                  src={`https://images.unsplash.com/photo-${1570554913382 + index}-930881f3d030?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80`}
                  alt={`Related product ${index + 1}`}
                  className="w-full h-full object-cover transition-transform duration-300 hover:scale-105"
                />
              </div>
              <div className="p-3">
                <h3 className="font-medium text-gray-900 truncate">Related Product {index + 1}</h3>

...
import { Sparkles, ShoppingCart, Heart, Search, Menu, X, User, Settings } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Link to="/" className="text-2xl font-bold text-gray-900 font-serif">GLOW</Link>
            </motion.div>
